...
$('#college-slider').owlCarousel({
	...
	responsiveClass:true,
	nav:true,
	navText: ["<div><img src='./img/carousel/prev-btn-black.png'></div>","<div><img src='./img/carousel/next-btn-black.png'></div>"],
	dots:false,
	margin:2,
	responsive:{
		0:{
...
function initMap() {
	map = new google.maps.Map(document.getElementById('map_canvas'), {
		center: {lat: 16.761520, lng: 77.133000},
		zoom: 18,
		scrollwheel: false,
	...
	var beachMarker = new google.maps.Marker({
		position: {lat: 16.761520, lng: 77.133000},
		map: map,
		icon: image
	});
}
